...
It is built with R using the R Markdown and flexdashboard framework and was adapted from the dashboard of [**Rami Krispin**](https://ramikrispin.github.io){target="_blank"}, courtesy of [**Antoine Soetewey**](https://github.com/AntoineSoetewey){target="_blank"}.
...
Automatic updates are performed daily at 12:00 PM EET.
...
daily_confirmed_deaths %>%
  ...
  bindCache(input$daily_confirmed_deaths)
...
daily_confirmed %>%
  ...
  bindCache(input$daily_confirmed)
